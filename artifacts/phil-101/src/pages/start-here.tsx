...
export default function StartHere() {
  ...
  const login = useLogin({
    mutation: {
      onSuccess: async () => {
        toast.success("Welcome to English Composition 101!");
  ...
  return (
    <PageShell
      title="Welcome to English Composition 101"
      intro="An introduction to college-level writing — the rhetorical situation, argument, evidence, style, and revision."
    >
      <Card>
        <CardHeader>
        ...
        <CardContent className="prose prose-stone max-w-none">
          <p>
            <strong>English Composition 101: College Writing</strong> is a
            fully online, asynchronous college-level course. Over 14 modules
            you will work through the rhetorical situation, thesis statements,
            argument structure, evidence and source evaluation, voice and
            style, the writing process, citation and intellectual honesty,
            clarity at the sentence level, and the role of AI in writing. The
            course culminates in a term paper that engages a foundational
            essay on writing.
          </p>
          <p>
            The <strong>AI Tutor</strong> on this site (Anthropic Claude Sonnet
            4.5) speaks for the instructor of record, asks probing questions
            about your choices as a writer, and gives formative feedback — but
            it will never write your work for you.
          </p>
        </CardContent>
      </Card>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <InfoCard
          ...
          body="Respectful disagreement is at the heart of good writing. Argue with the idea, not the person. Use clear, civil language in your AI Tutor sessions and submissions."
        />
        <InfoCard
      ...
      <Card>
        ...
        <CardContent className="prose prose-stone max-w-none">
          <p>
            The instructor of record for this course has taught college
            composition for over two decades. The teaching philosophy here is
            simple: writers improve by being asked the right questions about
            their choices, not by being handed the answer. The AI Tutor on
            this site is configured to teach in that voice and style.
          </p>
        </CardContent>
      </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <p className="text-sm text-stone-700">
              ...
              kind of writer you are now, and what you hope to get out of this
              course. Your tutor will use this to personalise its questions.
            </p>
            <Textarea
              rows={5}
              placeholder="I'm a sophomore studying biology, and I've always struggled with…"
